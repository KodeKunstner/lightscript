...
var passthrough = function() { return this.id; }
var literal = function() { return [this.id, this.val]; }
var infix = function (left) { return [this.id, left, parse(this.lbp)]; }
var infixr = function (left) { return [this.id, left, parse(this.lbp - 1)] }
var prefix = function() { return [this.id, parse()]; }
var prefix2 = function() { return [this.id, parse(), parse()]; }
var list = function() {
