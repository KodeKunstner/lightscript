...
The language should be easy to embed, so when targeting the JVM, most of the data types should map directly to standard Java classes, in order to make it easier for the developers to interface with the scripting language from the host application.
...
... clone... rather than the EcmaScript syntax with \verb|new|, $object$\verb|.prototype|. The \verb|clone| function can easily be implemented within pure EcmaScript
