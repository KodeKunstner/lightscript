...
There is a good introduction/survey on the topic \cite{gc-survey}, though it does not include more recent developments such as region based allocation \cite{region-gc}. 
...
monadic parser generators, and top down operator precedences parsers,
