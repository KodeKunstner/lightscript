...
\begin{abstract}
I dette speciale har jeg udviklet to nye scriptingsprog til mobiltelefoner: Yolan og LightScript.
...
\label{spidermonkey}
\index{SpiderMonkey}
SpiderMonkey \cite{spidermonkey} is the JavaScript engine in Mozilla's browsers, and is also usable as an embeddable engine in other applications. Execution is based on a virtual machine, which either has a switch-based dispatch or direct threading, depending on what the compiler supports. %TODO:verify-that-I-remember-correctly-here.
