...
The following paragraphsdescribes the main open source implementations of Java\-Script/EcmaScript.
...
\item Add simplified postfix increment/decrement, to be able to run some existing JavaScript code.
