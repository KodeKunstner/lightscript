...
The design should be inspired by EcmaScript/JavaScript, as this is the most distributed:FIXME:other-word scripting language, and is also a possible translation target for the scripting language implemented here.
