...
The motivation
%-- for making a simplified EcmaScript dialect that runs on limited devices --
...
%\nocite{blah}
% EcmaScript is the main client-side web scripting language, but is unsuitable for low-end mobile devices. 

%The motivation is to have a scripting language that runs on low end mobile phones as well as high 
%from a practical point of view is, that there are no scripting language that  is the desire for a scripting language that works across different platforms, including low end mobile phones.
% EcmaScript is the main client-side web scripting language. 
